//A simple macro to project and subtract the various regions
{
    ...
    TH1D *sub1 = new TH1D ("sub1", "sub1", 8192, 0., 4096.);
    sub1->Add(s1,b1,1,-1);
    TH1D *sub2 = new TH1D ("sub2", "sub2", 8192, 0., 4096.);
    sub2->Add(s2,b2,1,-1);
    
    TH1D *tot = new TH1D("tot","tot", 8192, 0., 4096.);
    ...
    TH1D *sub3 = new TH1D("sub3","sub3", 8192, 0., 4096.);
    sub3->Add(s3,b3,1,-1);
    ...
    TH1D *sub4 = new TH1D("sub4","sub4", 8192, 0., 4096.);
    sub3->Add(s4,b4,1,-1);
